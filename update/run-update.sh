...
version=$(cat /home/ver)
new_version=$( curl https://raw.githubusercontent.com/${GitUser}/multi-access/main/versi | grep $version )
#Status Version
...
wget -O cert "https://raw.githubusercontent.com/${GitUser}/scriptvps/main/cert.sh"
...
wget -O autobackup "https://raw.githubusercontent.com/${GitUser}/scriptvps/main/system/autobackup.sh"
