...
function menu1() {
  ...
  export patchtls=/timevpn-vmesswstls
  export patchnontls=/timevpn-vmesswsntls
...
END
  ...
  echo "vmess $user $exp $harini $uuid $get_AdminID $get_AdminID active" >>"/root/.database"
  #############
...
function menu3() {
  ...
  #############
  get_AdminID=$(sed -n '2 p' /root/ResBotAuth | cut -d' ' -f2)
  sed -i "/vmess $user $exp $harini $uuid/d" "/root/.database"
  echo "vmess $user $exp $harini $uuid $get_AdminID $get_AdminID inactive" >>"/root/.database"
  #############
...
function menu4() {
  ...
  get_AdminID=$(sed -n '2 p' /root/ResBotAuth | cut -d' ' -f2)
  sed -i "/vmess $user $exp $harini $uuid/d" "/root/.database"
  echo "vmess $user $exp4 $harini $uuid $get_AdminID $get_AdminID active" >>"/root/.database"
  #############
  systemctl restart xray@vmess
  systemctl restart xray@vmessnone
  service cron restart
...
function menu7() {
  ...
  export patchtls=/timevpn-vlesswstls
  export patchnontls=/timevpn-vlesswsntls
  export uuid=$(cat /proc/sys/kernel/random/uuid)
  ...
  #############
  get_AdminID=$(sed -n '2 p' /root/ResBotAuth | cut -d' ' -f2)
  echo "vless $user $exp $harini $uuid $get_AdminID $get_AdminID active" >>"/root/.database"
  #############
...
function menu9() {
  ...
  #############
  get_AdminID=$(sed -n '2 p' /root/ResBotAuth | cut -d' ' -f2)
  sed -i "/vless $user $exp $harini $uuid/d" "/root/.database"
  echo "vless $user $exp $harini $uuid $get_AdminID $get_AdminID inactive" >>"/root/.database"
  #############
  systemctl restart xray@vless
  systemctl restart xray@vlessnone
...
function menu10() {
  ...
  get_AdminID=$(sed -n '2 p' /root/ResBotAuth | cut -d' ' -f2)
  sed -i "/vless $user $exp $harini $uuid/d" "/root/.database"
  echo "vless $user $exp4 $harini $uuid $get_AdminID $get_AdminID active" >>"/root/.database"
  #############
  systemctl restart xray@vless
  systemctl restart xray@vlessnone
  service cron restart
...
function menu13() {
  ...
  #############
  get_AdminID=$(sed -n '2 p' /root/ResBotAuth | cut -d' ' -f2)
  echo "xtls $user $exp $harini $uuid $get_AdminID $get_AdminID active" >>"/root/.database"
  #############
...
function menu15() {
  ...
  #############
  get_AdminID=$(sed -n '2 p' /root/ResBotAuth | cut -d' ' -f2)
  sed -i "/xtls $user $exp $harini $uuid/d" "/root/.database"
  echo "xtls $user $exp $harini $uuid $get_AdminID $get_AdminID inactive" >>"/root/.database"
  #############
  systemctl restart xray.service
...
function menu16() {
  ...
  get_AdminID=$(sed -n '2 p' /root/ResBotAuth | cut -d' ' -f2)
  sed -i "/xtls $user $exp $harini $uuid/d" "/root/.database"
  echo "xtls $user $exp4 $harini $uuid $get_AdminID $get_AdminID active" >>"/root/.database"
  #############
  systemctl restart xray.service
  service cron restart
