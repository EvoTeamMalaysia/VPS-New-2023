...
patchtls=/timevpn-vmesswstls
patchnontls=/timevpn-vmesswsntls
...
patchtls=/timevpn-vlesswstls
patchnontls=/timevpn-vlesswsntls
uuid=$(cat /proc/sys/kernel/random/uuid)
read -p "   Bug Address (Example: www.google.com) : " address
read -p "   Bug SNI/Host (Example : m.facebook.com) : " sni
read -p "   Expired (days) : " masaaktif
...
patchtls=/timevpn-trojanwstls
patchnone=/timevpn-trojanwsntls
read -p "   Bug Address (Example: www.google.com) : " address
